...
def display_menu():
    menu = ["Home", "About", "Art", "Design", "Video", "3D Games", "IoT", "Graphics"]
    ...
    if choice == "Home":
        ...
        components.iframe("https://cdn.soft8soft.com/AROAJSY2GOEHMOFUVPIOE:85cf9c6521/Sub%20Python%20Game/Sub%20Python%20Game.html", width=800, heigth =600)
